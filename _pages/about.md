...
Junteng Liu is a first-year PhD candidate at the [HKUST NLP Group](https://github.com/HKUNLP), supervised by [Professor Junxian He](https://jxhe.github.io/). His research focuses on natural language processing and machine learning, with specific interests in LLM Reasoning and Reinforcement Learning, Hallucination in Vision-Language Models (VLM), and LLM Truthfulness and Interpretability.
